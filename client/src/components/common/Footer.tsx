      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Connect, share, and discover amazing content with our global
              community.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-300"
              >
                <Instagram size={20} />
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &copy; {currentYear} StoryNest. All rights reserved.
          </p>
