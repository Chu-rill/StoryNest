...
import { Menu, X, Search, User, LogOut, Moon, Sun, BellRing, PenSquare } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center text-xl font-bold text-blue-600 dark:text-blue-400">
              <span className="mr-2">Socialink</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            {isAuthenticated ? (
              <>
                <Link to="/create-post" className="p-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  <PenSquare size={20} />
                </Link>
